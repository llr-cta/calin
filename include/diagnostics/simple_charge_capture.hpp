/*
   ...
   calin/diagnostics/simple_charge_capture.hpp -- Stephen Fegan -- 2021-09-30

   Capture channel charge data and store it in memory
...
namespace calin { namespace diagnostics { namespace simple_charge_capture {

enum ChargeCaptureDatum {
  CCD_MAX_SAMPLE_VALUE = 0,
  CCD_MAX_SAMPLE_INDEX,
  CCD_BKG_WINDOW_SUM,
  CCD_SIG_WINDOW_SUM,
  CCD_OPT_WINDOW_SUM,
  CCD_OPT_WINDOW_SUM_QT,
  CCD_OPT_WINDOW_INDEX,
  CCD_WAVEFORM_SUM
};
