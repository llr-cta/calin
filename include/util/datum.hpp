...
inline Ellipse wgs84_ellipse() { return standard_ellipse(ELLIPSE_WGS84); }
inline Ellipse wgs72_ellipse() { return standard_ellipse(ELLIPSE_WGS72); }
inline Ellipse int24_ellipse() { return standard_ellipse(ELLIPSE_INT24); }
inline Ellipse grs80_ellipse() { return standard_ellipse(ELLIPSE_GRS80); }
inline Ellipse bessel_ellipse() { return standard_ellipse(ELLIPSE_BESSEL); }
