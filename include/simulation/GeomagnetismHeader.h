/*
   ...
   calin/simulation/GeomagnetismHeader.h -- Stephen Fegan -- 2016-11-22

   Header file from World Magnetic Model - available from
   https://www.ngdc.noaa.gov/geomag/WMM/DoDWMM.shtml

   The original header file is in the public domain. My changes are subject
   to the copyright notice below and may be distributed under the terms of
   the GPL license as detailed here.
...
int MAG_robustReadMagModels(const char *filename, MAGtype_MagneticModel **magneticmodels, int array_size);
...
int MAG_readMagneticModel_SHDF(const char *filename, MAGtype_MagneticModel **magneticmodels, int array_size);
