/*
   ...
   calin/math/brent.cpp -- Stephen Fegan -- 2015-03-24
   ...
   The majority of this code is Copyright 2011, John Burkardt,
...
//
  ...
  {
    if ( b <= a )
      throw std::runtime_error("LOCAL_MIN_RC: A < B is required");
...
} } } // end namespace calin::math::brent
