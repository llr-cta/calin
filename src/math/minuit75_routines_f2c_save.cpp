/* 
   ...
   subroutines as a pointer to a new super stuct "mn7fcb". All the
   subroutine calls were adapted to this.
...
int minuit_(S_fp fcn, U_fp futil, mn7fcb* fcb);
int mintio_(integer *i1, integer *i2, integer *i3, mn7fcb* fcb);
int mnamin_(S_fp fcn, U_fp futil, mn7fcb* fcb);
int mnbins_(doublereal *a1, doublereal *a2, integer *naa, doublereal *bl, doublereal *bh, integer *nb, doublereal *bwid, mn7fcb* fcb);
int mncalf_(S_fp fcn, doublereal *pvec, doublereal *ycalf, U_fp futil, mn7fcb* fcb);
int mncler_(mn7fcb* fcb);
int mncntr_(S_fp fcn, integer *ke1, integer *ke2, integer *ierrf, U_fp futil, mn7fcb* fcb);
int mncomd_(U_fp fcn, const char *crdbin, integer *icondn, U_fp futil, ftnlen crdbin_len, mn7fcb* fcb);
int mncont_(U_fp fcn, integer *ke1, integer *ke2, integer *nptu, doublereal *xptu, doublereal *yptu, integer *ierrf, U_fp futil, mn7fcb* fcb);
...
int mncros_(U_fp fcn, doublereal *aopt, integer *iercr, U_fp futil, mn7fcb* fcb);
int mncuve_(S_fp fcn, U_fp futil, mn7fcb* fcb);
int mnderi_(S_fp fcn, U_fp futil, mn7fcb* fcb);
...
int mneval_(S_fp fcn, doublereal *anext, doublereal *fnext, integer *ierev, U_fp futil, mn7fcb* fcb);
int mnexcm_(S_fp fcn, char *comand, doublereal *plist, integer *llist, integer *ierflg, U_fp futil, ftnlen comand_len, mn7fcb* fcb);
int mnexin_(doublereal *pint, mn7fcb* fcb);
int mnfixp_(integer *iint, integer *ierr, mn7fcb* fcb);
int mnfree_(integer *k, mn7fcb* fcb);
int mngrad_(S_fp fcn, U_fp futil, mn7fcb* fcb);
int mnhelp_(char *comd, integer *lout, ftnlen comd_len, mn7fcb* fcb);
int mnhes1_(S_fp fcn, U_fp futil, mn7fcb* fcb);
int mnhess_(S_fp fcn, U_fp futil, mn7fcb* fcb);
int mnimpr_(S_fp fcn, U_fp futil, mn7fcb* fcb);
...
int mnintr_(S_fp fcn, U_fp futil, mn7fcb* fcb);
int mnlims_(mn7fcb* fcb);
int mnline_(S_fp fcn, doublereal *start, doublereal *fstart, doublereal *step, doublereal *slope, doublereal *toler, U_fp futil, mn7fcb* fcb);
int mnmatu_(integer *kode, mn7fcb* fcb);
int mnmigr_(S_fp fcn, U_fp futil, mn7fcb* fcb);
int mnmnos_(S_fp fcn, U_fp futil, mn7fcb* fcb);
int mnmnot_(S_fp fcn, integer *ilax, integer *ilax2, doublereal *val2pl, doublereal *val2mi, U_fp futil, mn7fcb* fcb);
...
int mnread_(S_fp fcn, integer *iflgin, integer *iflgut, U_fp futil, mn7fcb* fcb);
int mnrn15_(doublereal *val, integer *inseed, mn7fcb* fcb);
int mnrset_(integer *iopt, mn7fcb* fcb);
int mnsave_(mn7fcb* fcb);
int mnscan_(S_fp fcn, U_fp futil, mn7fcb* fcb);
int mnseek_(S_fp fcn, U_fp futil, mn7fcb* fcb);
int mnset_(S_fp fcn, U_fp futil, mn7fcb* fcb);
int mnseti_(char *tit, ftnlen tit_len, mn7fcb* fcb);
int mnsimp_(S_fp fcn, U_fp futil, mn7fcb* fcb);
...
/*               . . . . . . . . . . .   set parameter lists to undefined */
    mncler_(fcb);
/*                                             . . . . . . . . read title */
    mnread_((S_fp)fcn, &c__1, &iflgut, (U_fp)futil, fcb);
    if (iflgut == 2) {
	goto L500;
    }
    if (iflgut == 3) {
...
/*                                        . . . . . . . . read parameters */
    mnread_((S_fp)fcn, &c__2, &iflgut, (U_fp)futil, fcb);
    if (iflgut == 2) {
	goto L500;
    }
    if (iflgut == 3) {
...
/*                              . . . . . . verify FCN not time-dependent */
    ...
    mninex_(x,fcb);
    fzero = undefi;
    (*fcn)(&nparx, gin, &fzero, u, &c__1, (U_fp)futil);
    first = undefi;
    (*fcn)(&nparx, gin, &first, u, &c__4, (U_fp)futil);
    nfcn = 2;
    ...
    fnew = 0.f;
    (*fcn)(&nparx, gin, &fnew, u, &c__4, (U_fp)futil);
    if (fnew != amin) {
...
L300:
    fval3 = amin * 2.f + 1.f;
/*                                   . . . . . . . . . . . read commands */
    mnread_((S_fp)fcn, &c__3, &iflgut, (U_fp)futil, fcb);
    if (iflgut == 2) {
	goto L500;
    }
    if (iflgut == 3) {
...
/* Subroutine */ int minuit_(S_fp fcn, U_fp futil, mn7fcb* fcb)
{
    return minuit_0_(0, fcn, futil, (integer *)0, (integer *)0, (integer *)0, fcb);
    }

/* Subroutine */ int mintio_(integer *i1, integer *i2, integer *i3, mn7fcb* fcb)
{
  return minuit_0_(1, (S_fp)0, (U_fp)0, i1, i2, i3, fcb);
    }
#define u (fcb->mn7ext_1.u)
#define x (fcb->mn7int_1.x)
#define gin (fcb->mn7der_1.gin)
...
/* Subroutine */ int mnamin_(S_fp fcn, U_fp futil, mn7fcb* fcb)
{
    /* Local variables */
    static doublereal fnew;
    static integer nparx;
...
/* d506cm.inc */
    ...
    nparx = npar;
    mninex_(&pvec[1], fcb);
    (*fcn)(&nparx, gin, &f, u, &c__4, (U_fp)futil);
    ++nfcn;
    i__1 = npar;
...
/*                 input arguments: parx, pary, devs, ngrid */
    ...
    if (isw[1] < 1) {
	mnhess_((S_fp)fcn, (U_fp)futil, fcb);
	mnwerr_(fcb);
    }
    nparx = npar;
    xsav = u[*ke1 - 1];
...
/*         ask if parameter outside limits */
    ...
    if (amin == undefi) {
	mnamin_((S_fp)fcn, (U_fp)futil, fcb);
    }
...
/*                fill FCNB to prepare first row, and find column zero */
	...
	(*fcn)(&nparx, gin, &ff, u, &c__4, (U_fp)futil);
	fcnb[ix - 1] = ff;
	if (xb4 < 0. && u[*ke1 - 1] > 0.) {
	    ixzero = ix - 1;
	}
...
/* Subroutine */ int mncomd_(U_fp fcn, const char *crdbin, integer *icondn, U_f futil, ftnlen crdbin_len, mn7fcb* fcb)
{
    /* Initialized data */
...
/*               crack the command . . . . . . . . . . . . . . . . */
	...
	*icondn = 2;
    ...
    mnexcm_((U_fp)fcn, comand, plist, &llist, &ierr, (U_fp)futil, lnc, fcb);
    *icondn = ierr;
L900:
    return 0;
} /* mncomd_ */
...
/* Subroutine */ int mncont_(U_fp fcn, integer *ke1, integer *ke2, integer *
	nptu, doublereal *xptu, doublereal *yptu, integer *ierrf, U_fp futil, mn7fcb* fcb)
{
    /* System generated locals */
    integer i__1, i__2;
...
/*           The minimum */
    mncuve_((U_fp)fcn, (U_fp)futil, fcb);
    u1min = u[*ke1 - 1];
    u2min = u[*ke2 - 1];
    *ierrf = 0;
...
/*              ........................ first two points */
    mnmnot_((U_fp)fcn, ke1, ke2, &val2pl, &val2mi, (U_fp)futil, fcb);
    if (ern[ki1 - 1] == undefi) {
	xptu[1] = alim[*ke1 - 1];
...
/*              ........................... next two points */
    mnmnot_((U_fp)fcn, ke2, ke1, &val2pl, &val2mi, (U_fp)futil, fcb);
    if (ern[ki2 - 1] == undefi) {
	yptu[2] = alim[*ke2 - 1];
	mnwarn_("W", "MNContour ", "Contour squeezed by parameter limits.", (
		ftnlen)1, (ftnlen)10, (ftnlen)37, fcb);
...
/*                Find the contour crossing point along DIR */
	amin = abest;
	mncros_((U_fp)fcn, &aopt, &iercr, (U_fp)futil, fcb);
	if (iercr > 1) {
...
/* Subroutine */ int mncros_(U_fp fcn, doublereal *aopt, integer *iercr, U_fp futil, mn7fcb* fcb)
{
    /* Initialized data */
...
/*          first point */
    ...
    *aopt = anext;
    ...
    mneval_((U_fp)fcn, &anext, &fnext, &ierev, (U_fp)futil, fcb);
/* debug printout: */
    if (ldebug) {
...
/* Computing MAX */
	...
	*aopt = aulim;
    ...
    mneval_((U_fp)fcn, aopt, &fnext, &ierev, (U_fp)futil, fcb);
/* debug printout: */
    if (ldebug) {
...
/* Subroutine */ int mncuve_(S_fp fcn, U_fp futil, mn7fcb* fcb)
{
    /* System generated locals */
    integer i__1, i__2;
    doublereal d__1;
...
/* d506cm.inc */
	...
	e_wsfe();
	apsi = epsi;
	mnmigr_((S_fp)fcn, (U_fp)futil, fcb);
    }
    if (isw[1] < 3) {
	mnhess_((S_fp)fcn, (U_fp)futil, fcb);
	if (isw[1] < 1) {
...
/* Subroutine */ int mnderi_(S_fp fcn, U_fp futil, mn7fcb* fcb)
{
    /* Format strings */
...
/*                       make sure starting at the right place */
	mninex_(x, fcb);
	nparx = npar;
	(*fcn)(&nparx, gin, &fs1, u, &c__4, (U_fp)futil);
	++nfcn;
	if (fs1 != amin) {
	    df = amin - fs1;
	    s_wsfi(&io___255);
...
/*         take step negative */
	    x[i__ - 1] = xtf - step;
	    mninex_(x, fcb);
	    (*fcn)(&nparx, gin, &fs2, u, &c__4, (U_fp)futil);
	    ++nfcn;
	    grbfor = grd[i__ - 1];
...
/* Subroutine */ int mneval_(S_fp fcn, doublereal *anext, doublereal *fnext, 
	integer *ierev, U_fp futil, mn7fcb* fcb)
{
    static integer nparx;
...
/* C */
    ...
    mninex_(x, fcb);
    nparx = npar;
    (*fcn)(&nparx, gin, fnext, u, &c__4, (U_fp)futil);
    ++nfcn;
    *ierev = 0;
    if (npar > 0) {
	itaur = 1;
...
/* Subroutine */ int mnexcm_(S_fp fcn, char *comand, doublereal *plist, 
	integer *llist, integer *ierflg, U_fp futil, ftnlen comand_len, mn7fcb* fcb)
{
    /* Initialized data */
...
/*                                        . . . . . . . . . . seek */
L200:
    mnseek_((S_fp)fcn, (U_fp)futil, fcb);
    goto L5000;
/*                                        . . . . . . . . . . simplex */
L300:
    mnsimp_((S_fp)fcn, (U_fp)futil, fcb);
    if (isw[3] < 1) {
	*ierflg = 4;
    }
    goto L5000;
...
/*          possible loop over new minima */
    epsi = up * .1f;
L510:
    mncuve_((S_fp)fcn, (U_fp)futil, fcb);
    mnmnos_((S_fp)fcn, (U_fp)futil, fcb);
    if (! lnewmn) {
	goto L5000;
    }
    mnrset_(&c__0, fcb);
...
/*                                        . . . . . . . . . .set, show */
L700:
    mnset_((S_fp)fcn, (U_fp)futil, fcb);
    goto L5000;
/*                                        . . . . . . . . . . top of page */
L800:
...
L1210:
    mnscan_((S_fp)fcn, (U_fp)futil, fcb);
    goto L5000;
L1250:
...
L1300:
    ...
    nfcnmx = 1000;
    mncntr_((S_fp)fcn, &ke1, &ke2, &ierrf, (U_fp)futil, fcb);
    if (ierrf > 0) {
	*ierflg = 3;
    }
    goto L5000;
...
L1600:
    mncuve_((S_fp)fcn, (U_fp)futil, fcb);
    mnimpr_((S_fp)fcn, (U_fp)futil, fcb);
    if (lnewmn) {
	goto L400;
    }
    *ierflg = 4;
...
L1700:
    ...
    nparx = npar;
    f = undefi;
    (*fcn)(&nparx, gin, &f, u, &iflag, (U_fp)futil);
    ++nfcn;
    nowprt = 0;
    if (f != undefi) {
	if (amin == undefi) {
...
L2400:
    ...
    nfcnmx = (nptu + 5) * 100 * (npar + 1);
    mncont_((S_fp)fcn, &ke1, &ke2, &nptu, xptu, yptu, &ierrf, (U_fp)futil, fcb);
    if (ierrf < nptu) {
	*ierflg = 4;
    }
    if (ierrf == -1) {
...
/* Subroutine */ int mngrad_(S_fp fcn, U_fp futil, mn7fcb* fcb)
{
    /* Format strings */
...
/* L30: */
    ...
    mninex_(x, fcb);
    (*fcn)(&nparx, gin, &fzero, u, &c__2, (U_fp)futil);
    ++nfcn;
    mnderi_((S_fp)fcn, (U_fp)futil, fcb);
    i__1 = npar;
    for (i__ = 1; i__ <= i__1; ++i__) {
/* L40: */
	gf[i__ - 1] = grd[i__ - 1];
...
/*                    get MINUIT-calculated first derivatives */
    ...
    istsav = istrat;
    istrat = 2;
    mnhes1_((S_fp)fcn, (U_fp)futil, fcb);
    istrat = istsav;
...
/* Subroutine */ int mnhes1_(S_fp fcn, U_fp futil, mn7fcb* fcb)
{
    /* Format strings */
...
/* Subroutine */ int mnhess_(S_fp fcn, U_fp futil, mn7fcb* fcb)
{
    /* Format strings */
...
/* Subroutine */ int mnimpr_(S_fp fcn, U_fp futil, mn7fcb* fcb)
{
    /* Initialized data */
...
L30:
    mncalf_((S_fp)fcn, x, &ycalf, (U_fp)futil, fcb);
    amin = ycalf;
...
/* L60: */
    ...
    mncalf_((S_fp)fcn, pstar, &ycalf, (U_fp)futil, fcb);
    ystar = ycalf;
    if (ystar >= amin) {
	goto L70;
    }
...
/* L61: */
    ...
    mncalf_((S_fp)fcn, pstst, &ycalf, (U_fp)futil, fcb);
    ystst = ycalf;
/* L66: */
    if (ystst < y[jl - 1]) {
	goto L67;
...
L100:
    mninex_(x, fcb);
    (*fcn)(&nparx, gin, &amin, u, &c__4, (U_fp)futil);
    ++nfcn;
    i__1 = npar;
    for (i__ = 1; i__ <= i__1; ++i__) {
...
/* Subroutine */ int mnintr_(S_fp fcn, U_fp futil, mn7fcb* fcb)
{
    /* Local variables */
...
/* d506cm.inc */
    ...
    iflgin = 3;
    mnread_((S_fp)fcn, &iflgin, &iflgut, (U_fp)futil, fcb);
...
/* Subroutine */ int mnline_(S_fp fcn, doublereal *start, doublereal *fstart, 
	doublereal *step, doublereal *slope, doublereal *toler, U_fp futil, mn7fcb* fcb)
{
    /* Initialized data */
...
/*                              debug check if start is ok */
    if (ldebug) {
	mninex_(&start[1], fcb);
	(*fcn)(&nparx, gin, &f1, u, &c__4, (U_fp)futil);
	++nfcn;
	if (f1 != *fstart) {
...
/* L30: */
    ...
    mninex_(x, fcb);
    (*fcn)(&npar, gin, &f2, u, &c__4, (U_fp)futil);
    ++nfcn;
    ++nxypt;
    *(unsigned char *)&chpq[nxypt - 1] = *(unsigned char *)&charal[nxypt - 1];
    xpq[nxypt - 1] = slam;
...
/* L60: */
    ...
    mninex_(x, fcb);
    (*fcn)(&nparx, gin, &f3, u, &c__4, (U_fp)futil);
    ++nfcn;
    ++nxypt;
    *(unsigned char *)&chpq[nxypt - 1] = *(unsigned char *)&charal[nxypt - 1];
    xpq[nxypt - 1] = slam;
...
/* Subroutine */ int mnmigr_(S_fp fcn, U_fp futil, mn7fcb* fcb)
{
    /* Format strings */
...
/*                           do line search if second derivative negative */
	...
	for (i__ = 1; i__ <= i__1; ++i__) {
	    ...
	    fs = amin;
	    mnline_((S_fp)fcn, xxs, &fs, step, &gdel, &c_b1196, (U_fp)futil, fcb);
...
/* Subroutine */ int mnmnos_(S_fp fcn, U_fp futil, mn7fcb* fcb)
{
    /* Format strings */
...
/*                                         calculate one pair of M E's */
	ilax2 = 0;
	mnmnot_((S_fp)fcn, &ilax, &ilax2, &val2pl, &val2mi, (U_fp)futil, fcb);
	if (lnewmn) {
	    goto L650;
	}
...
/* Subroutine */ int mnmnot_(S_fp fcn, integer *ilax, integer *ilax2, 
	doublereal *val2pl, doublereal *val2mi, U_fp futil, mn7fcb* fcb)
{
    /* Format strings */
...
/*                                        loop to hit AMIN+UP */
	...
	amin = abest;
	nfcnmx = nlimit - nfcn;
	mncros_((S_fp)fcn, &aopt, &iercr, (U_fp)futil, fcb);
...
/*                                           read commands */
L300:
    mncomd_((S_fp)fcn, crdbuf, &icondn, (U_fp)futil, (ftnlen)80, fcb);
/* C     ICONDN = 0: command executed normally */
/* C              1: command is blank, ignored */
/* C              2: command line unreadable, ignored */
/* C              3: unknown command, ignored */
...
/* Subroutine */ int mnscan_(S_fp fcn, U_fp futil, mn7fcb* fcb)
{
    /* Format strings */
...
/* Subroutine */ int mnseek_(S_fp fcn, U_fp futil, mn7fcb* fcb)
{
    /* Format strings */
...
/* L100: */
	...
	mninex_(x, fcb);
	(*fcn)(&nparx, gin, &ftry, u, &c__4, (U_fp)futil);
	++nfcn;
	if (ftry < flast) {
	    if (ftry < amin) {
		s_copy(cstatu, "IMPROVEMNT", (ftnlen)10, (ftnlen)10);
...
/* Subroutine */ int mnset_(S_fp fcn, U_fp futil, mn7fcb* fcb)
{
    /* Initialized data */
...
/*                                        . . . . . . . . . . set grad */
L80:
    mngrad_((S_fp)fcn, (U_fp)futil, fcb);
    goto L4000;
/*                                        . . . . . . . . . . set errdef */
L90:
    if (word7[0] == up) {
...
/* Subroutine */ int mnsimp_(S_fp fcn, U_fp futil, mn7fcb* fcb)
{
    /* Initialized data */
...
/* L60: */
    ...
    mninex_(pstar, fcb);
    (*fcn)(&nparx, gin, &ystar, u, &c__4, (U_fp)futil);
    ++nfcn;
    if (ystar >= amin) {
	goto L70;
    }
...
/* L61: */
    ...
    mninex_(pstst, fcb);
    (*fcn)(&nparx, gin, &ystst, u, &c__4, (U_fp)futil);
    ++nfcn;
...
/* L64: */
    ...
    mninex_(prho, fcb);
    (*fcn)(&nparx, gin, &yrho, u, &c__4, (U_fp)futil);
    ++nfcn;
    if (yrho < amin) {
	s_copy(cstatu, "PROGRESS  ", (ftnlen)10, (ftnlen)10);
    }
...
/* L82: */
    ...
    mninex_(pbar, fcb);
    (*fcn)(&nparx, gin, &ypbar, u, &c__4, (U_fp)futil);
    ++nfcn;
    if (ypbar < amin) {
