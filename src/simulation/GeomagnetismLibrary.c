/*
   ...
   calin/simulation/GeomagnetismLibrary.c -- Stephen Fegan -- 2016-11-22

   Code file from World Magnetic Model - available from
   https://www.ngdc.noaa.gov/geomag/WMM/DoDWMM.shtml

   The original code file is in the public domain. My changes are subject
