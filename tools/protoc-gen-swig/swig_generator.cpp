...
void print_message(Printer* I, const google::protobuf::Descriptor* d)
{
  ...
  I->Print(
    ...
    "      std::string serialized_data = $$self->SerializeAsString();\n"
    "      PyObject* state_dict = PyDict_New();\n"
    "      PyDict_SetItemString(state_dict, \"serialized_data\",\n"
    "        PyBytes_FromStringAndSize(&serialized_data.front(), serialized_data.size()));\n"
    "      return state_dict;\n"
    "    }\n"
    "    void __setstate__(PyObject* state_dict) {\n"
    "      PyObject* serialized_data_obj = PyDict_GetItemString(state_dict, \"serialized_data\");\n"
    "      if(serialized_data_obj and PyString_Check(serialized_data_obj)) {\n"
    "        std::string serialized_data(PyString_AsString(serialized_data_obj),\n"
    "          PyString_Size(serialized_data_obj));\n"
    "        $$self->Clear();\n"
