...
def runScript():
	...
	if (not SimpleModel):
		...
		result,aerror,b,c,d = calin.SPEFit.Fit_2_gauss(DataListSignal,DataListSignal,1000)
		...
		result,aerror,b,c,d = calin.SPEFit.Fit_1_gauss(DataListSignal,DataListSignal,1000)
	...
	if (not SimpleModel):
		...
		ses_mean_uncertainty = calin.SPEFit.GainUncertainty(0.715,0.45,result[3],result[4],aerror[4],aerror[3])
